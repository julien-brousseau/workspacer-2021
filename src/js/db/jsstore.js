...
const seedWorkspaces = async () => {
  ...
  await connection.insert({
    into: 'tabs',
    values: [
      { wsId: 1, title: 'Tab 1', url: '1.com' },
      { wsId: 1, title: 'Tab 2', url: '2.com' },
      { wsId: 1, title: 'Tab 3', url: '3.com' },
      { wsId: 2, title: 'Tab 4', url: '4.com' },
      { wsId: 2, title: 'Tab 5', url: '5.com' },
      { wsId: 3, title: 'Tab 6', url: '6.com' },
    ],
  });
  return;
};
